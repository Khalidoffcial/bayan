    ...
    <div>
      <div className="section-header">
        ...
        <p className="section-subtitle">
          Unlock AI tools, advanced analytics, and creator monetization
        </p>
      </div>

      <div className="settings-card">
        <div className="card-title">
          <span className="card-title-icon">◈</span> Current Plan
        </div>
        <div className="plan-current" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
          <div>
            <div className="plan-name-badge" style={{ fontWeight: 600 }}>⚡ Explorer — Free</div>
            <div className="plan-label" style={{ fontSize: 12, color: "var(--text3)" }}>Your current plan · Renews never</div>
          </div>
          <button className="btn btn-outline btn-sm">Manage billing</button>
        </div>
        <p style={{ fontSize: 13, color: "var(--text2)", marginBottom: 16 }}>
          Upgrade to unlock the full Bayan experience.
        </p>
        <div
          style={{
            display: "grid",
          ...
          {PLANS.map((plan) => (
            ...
            >
              ...
              {plan.current ? (
                ...
                <button
                  className={`btn btn-sm btn-full ${plan.id === "thinker" ? "btn-primary" : "btn-outline"
                    }`}
                  style={{ width: "100%" }}
                >
                  Upgrade
      ...
      <div className="settings-card">
        <div className="card-title">
          <span className="card-title-icon">◈</span> Premium Features
        </div>
...
export default React.memo(PremiumSettings);

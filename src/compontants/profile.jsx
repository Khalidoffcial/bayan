...
const SOCKET_URL =
  "bayan-production-9dd3.up.railway.app";
...
useEffect(() => {
  ...
  if (UserDataMain?.id && idOtherUser && idOtherUser !== UserDataMain.id) {
    ...
    axios
      .post(
        "bayan-production-9dd3.up.railway.app/getuser",
        { idOtherUser },
        {
          headers: {
...
function unfollowUser() {
  ...
  axios
  .post(
      "bayan-production-9dd3.up.railway.app/followingUser",
      {  IdUser: parsed.id,
    idFollowedUser:idOtherUser },
    {
        headers: {
  ...
  axios
  .post(
      "bayan-production-9dd3.up.railway.app/unfollowingUser",
      {  IdUser: parsed.id,
    idFollowedUser:idOtherUser },
    {
        headers: {
...
function updataWithServer(Updatable, status) {
  axios
    .post(
      "bayan-production-9dd3.up.railway.app/editProfile",
      { Updatable, status },
      {
        headers: {
          Authorization: "Bearer " + cookie("get"),
